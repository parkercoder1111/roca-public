...
function matchSkillForTask(task: { title: string; notes?: string | null }): { name: string; content: string } | null {
  ...
  const patterns: [string[], string][] = [
    ...
    [['campaign followup', '2nd touch', '3rd touch'], 'email-campaign-followup'],
    [['pass on', 'passing on', 'communicating a pass'], 'email-pass'],
    [['tracker', 'weekly kr'], 'sheets-vai-tracker'],
    ...
    [['update crm', 'change tier', 'add to crm', 'crm update'], 'crm-write-update'],
    ...
    [['find companies using', 'api exploration'], 'research-api-exploration'],
