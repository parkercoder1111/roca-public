...
// 'carried' is intentionally excluded — it's a tombstone for tasks that were
// rolled forward to a new week, not active work. Including it would resurface
// already-carried tasks in prior-week views (Carried section, folders, counts).
