...
let sseStartTimer: ReturnType<typeof setTimeout> | null = null
...
function startPolling() {
  ...
  pollInterval = setInterval(async () => {
    ...
    try {
      ...
      // pty:data events are handled per-component (TerminalView polls scrollback directly)
...
export const api = {
  ...
  resizePty: (ptyId: string, cols: number, rows: number) => rpc('pty:resize', { ptyId, cols, rows }),
