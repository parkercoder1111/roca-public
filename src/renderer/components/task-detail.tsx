...
import { SOURCE_COLORS, SOURCE_LABELS_FULL as SOURCE_LABELS } from '../lib/source-meta'
...
export function TaskDetail({
  ...
  const saveNotes = useCallback((text: string) => {
    ...
    notesTimer.current = setTimeout(async () => {
      await window.electronAPI.updateNotes(task.id, text).catch(err => console.error('[TaskDetail] updateNotes timeout failed:', err))
      pendingNotesRef.current = ''
      setNotesSaved(true)
      onNotesChange()
